...
export const PRODUCT_MODAL_CLOSE = "PRODUCT_MODAL_CLOSE";
export const PRODUCT_DELETE_MODAL_OPEN = "PRODUCT_DELETE_MODAL_OPEN";
export const PRODUCT_DELETE_MODAL_CLOSE = "PRODUCT_DELETE_MODAL_CLOSE";
